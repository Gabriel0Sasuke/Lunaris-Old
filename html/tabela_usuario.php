...
$dados = $sql->query("SELECT user_id, user_nome, user_usuario, user_email, user_senha, user_cargo FROM usuario");
?>
...
<body>
    ...
    <?php
    if($dados->num_rows == 0){
        echo "<div id='nenhum-usuario'>Nenhum usuario cadastrado</div>";
    }else{ ?>
    <main id="div-tabela">
