        ...
        <div id="principal">
            ...
            <form action="login.php" method="post">
                ...
                <div id="campo">
                    ...
                    <br>
                    <input type="email" name="email" id="email" placeholder="Digite seu Email" maxlength="200" required tabindex="1">
                </div>
                ...
                <div id="campo">
                    ...
                    <label id="termostexto" for="termos">Lembre-se de Mim</label>
                </div>

                <button type="submit" tabindex="6">Logar</button>
            </form>
        </div>
